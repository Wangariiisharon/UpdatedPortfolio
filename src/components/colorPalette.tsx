      ...
      <div className="w-full space-y-8">
        ...
        <div className="grid gap-6 mb-6">
          <div className="space-y-5">
            ...
            <div className="flex gap-4">
              <input
                ...
                className="w-16 h-16 rounded border-2 border-gray-700 cursor-pointer bg-gray-800"
              />
              <input
                type="text"
                value={baseColor}
                onChange={(e) => setBaseColor(e.target.value)}
                className="flex-1 bg-gray-800 text-white px-4 py-2 rounded border border-gray-700 font-mono focus:border-gray-600 focus:outline-none"
                placeholder="#3B82F6"
              />
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <select
              ...
              className="w-full bg-gray-800 text-white px-4 py-3 rounded border border-gray-700 focus:border-gray-600 focus:outline-none cursor-pointer"
            >
              {schemes.map((s) => (
        ...
        <div className="space-y-6 mb-6">
          {palette.map((color, index) => (
            <div
              key={index}
              className="flex items-center gap-4 p-4 bg-gray-900 border border-gray-800 rounded hover:border-gray-700 transition-colors group"
            >
              <div
